...
const SearchBar = () => {
  ...
  return showSearch && visible ? (
    <div className='border-t border-b bg-gray-50 text-center'>
      <div className='inline-flex items-center justify-center border border-gray-400 px-2 py-5 my-5 mx-3 rounded-full w-3/4 sm:w-1/2'>
        ...
        <img src={assets.search_icon} className='w-4' calt="" />
      </div>
